...
public class Exemplo11Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(Exemplo11Activity.this, "Clique comum: " + textos.get(i), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        this.lista.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                // Os números dos itens iniciam-se em 0 (zero)
                // É o mesmo índice do elemento no ArrayList com os dados
                Toast.makeText(Exemplo11Activity.this, "Clique longo: " + textos.get(i), Toast.LENGTH_SHORT).show();
